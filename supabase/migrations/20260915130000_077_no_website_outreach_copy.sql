/*
  # No-website outreach copy

  Friendly, conversation-first note. CTA is the public directory page.
  Website price is NZD $650 one-off. No "free to start".
*/
...
-- Bulk enqueue: no-website (and cold invite) link to the public directory page.
    ...
    SELECT
      ...
      CASE
        ...
        ELSE public.outreach_email_body(
          ...
          t.name,
          CASE
            WHEN p_template IN ('outreach_cold_invite', 'outreach_no_website') THEN
