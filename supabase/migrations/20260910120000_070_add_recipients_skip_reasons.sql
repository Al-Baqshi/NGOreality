/*
  # Return named skip reasons from outreach_schedule_add_recipients

  Staff need to see *who* was skipped and *why* (no email, suppressed,
  already on roster, already emailed), not only aggregate counts.
*/
