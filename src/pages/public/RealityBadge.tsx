...
export default function RealityBadge() {
  return (
    <>
      <SEO
        title="Reality Badge"
        description="The NGOreality Reality Badge is a public trust signal for nonprofits. Learn about our two-tier verification system: Verified (digital & operational) and Transparent Financial."
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-ink-600 leading-relaxed mb-6">
                  Each verified organization receives the NGOreality Reality Badge, a unique verification ID, and a public verification page. Organizations that meet financial transparency standards receive the Transparent Financial badge.
                </p>
                <ul className="space-y-3">
                  {[
