        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          <div className="max-w-2xl mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-2xs uppercase tracking-[0.3em] text-ink-400">Two Tiers</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-ink-600 leading-relaxed mb-6">
                Each verified organization receives a verification badge, a unique verification ID, and a public verification page. Organizations that meet financial transparency standards receive the Transparent Financial badge.
              </p>
              <ul className="space-y-3">
                {[
                  ...
                  'Distinct badge for financial transparency tier',
                ].map((item) => (
                  <li key={item} className="flex items-start gap-3">
