        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-2xs uppercase tracking-[0.3em] text-ink-300">Verification Standard</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tight mb-4">
              What verification means
            </h1>
            <p className="text-ink-300 text-lg">
              NGOreality verification is a public trust signal. It means an organization has met defined digital and transparency standards.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-2xl mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-2xs uppercase tracking-[0.3em] text-ink-400">
                {FINANCIAL_VERIFICATION_ENABLED ? 'Two Tiers' : 'Launch tier'}
              </span>
            </div>
            ...
            {!FINANCIAL_VERIFICATION_ENABLED && (
              <p className="text-sm text-ink-500 mt-2">
                We onboard NGOs on digital trust first (website, security, privacy, accessibility). Financial transparency tier coming soon.
              </p>
            )}
          </div>
      ...
      <section className="border-b-3 border-ink-950 bg-surface-overlay">
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-black uppercase tracking-tight mb-6">Verification is</h2>
            ...
            <div>
              <h2 className="text-3xl font-black uppercase tracking-tight mb-6">Verification is not</h2>
              <ul className="space-y-3">
                {[
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-ink-600 leading-relaxed mb-6">
                Each verified organization receives the Reality Badge, a unique verification ID, and a public verification page.
                {!FINANCIAL_VERIFICATION_ENABLED && ' Financial transparency badge — coming soon.'}
                {FINANCIAL_VERIFICATION_ENABLED && ' Organizations that meet financial transparency standards receive the Transparent Financial badge.'}
              </p>
              <ul className="space-y-3">
      ...
      <section className="bg-ink-950 text-white">
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-24 text-center">
          ...
          <p className="text-ink-300 max-w-lg mx-auto mb-8">
            Start the verification process and join the standard for nonprofit trust.
          </p>
